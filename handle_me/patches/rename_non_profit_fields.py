...
def execute():
	if frappe.db.table_exists("Donation"):
		frappe.reload_doc("handle_me", "doctype", "Donation")

		rename_field("Donation", "razorpay_payment_id", "payment_id")

	if frappe.db.table_exists("Tax Exemption 80G Certificate"):
		frappe.reload_doc("handle_me", "doctype", "Tax Exemption 80G Certificate")
		frappe.reload_doc("handle_me", "doctype", "Tax Exemption 80G Certificate Detail")
