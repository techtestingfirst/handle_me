...
from handle_me.handle_me.doctype.membership_type.membership_type import get_membership_type
...
class Member(Document):
	...
	if TYPE_CHECKING:
		...
		member_name: DF.Data
		membership_expiry_date: DF.Date | None
		membership_type: DF.Link
		naming_series: DF.Literal["NPO-MEM-.YYYY.-"]
		subscription_end: DF.Date | None
		subscription_id: DF.Data | None
		subscription_start: DF.Date | None
		subscription_status: DF.Literal["", "Active", "Halted"]
