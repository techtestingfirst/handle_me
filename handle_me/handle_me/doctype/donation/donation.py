...
from handle_me.handle_me.doctype.membership.membership import verify_signature
...
class Donation(Document):
	...
	def create_payment_entry(self, date=None):
		...
		from handle_me.handle_me.custom_doctype.payment_entry import get_donation_payment_entry
...
def get_company_for_donations():
	...
	if not company:
		from handle_me.handle_me.utils import get_company
		company = get_company()
	return company
